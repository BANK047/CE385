import { FunctionDeclaration, Tool, GoogleGenerativeAI, SchemaType } from "@google/generative-ai";
        ...
        functionDeclarations: [
            {
                ...
                parameters: {
                    ...
                    properties: {
                        ...
                        action: {
                            type: SchemaType.STRING,
                            description: "The Prisma action: findMany, findUnique, findFirst, count",
                        },
                        args: {
                            type: SchemaType.OBJECT,
...
export async function askAI(userMessage: string): Promise<string> {
    ...
    You are an AI assistant that helps user query a database. 
